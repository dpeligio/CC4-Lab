...
public class MyAVL {
    ...
    public void printArray(Node root) {
            ...
            if(i < height - 1) {
                ...
                for(Node n : current) {
                    ...
                    if(n == null)
                        ...
                        System.out.printf(
                            n.left == null ? "null " : "", n.right == null ? "null " : ""
                        );
